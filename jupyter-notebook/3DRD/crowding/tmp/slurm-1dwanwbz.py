...
import os
import pickle
with open('/home/chew/notebook/jupyter-notebook/3DRD/crowding/tmp/slurm-dbeql7p9.pickle', 'rb') as fin:
    job = pickle.load(fin)
pass
from numpy import *
from ecell4 import *
...
filenames = ['/home/chew/notebook/jupyter-notebook/3DRD/crowding/tmp/slurm-immzzqcs.pickle', '/home/chew/notebook/jupyter-notebook/3DRD/crowding/tmp/slurm-89lro0cx.pickle', '/home/chew/notebook/jupyter-notebook/3DRD/crowding/tmp/slurm-bo0djfn4.pickle', '/home/chew/notebook/jupyter-notebook/3DRD/crowding/tmp/slurm-4ev8d4_7.pickle', '/home/chew/notebook/jupyter-notebook/3DRD/crowding/tmp/slurm-pnk_mmkm.pickle']
